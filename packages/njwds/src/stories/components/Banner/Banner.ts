...
export const BannerComponent = ({ governor, ltgovernor }: BannerProps) => {
  return html`
    <section aria-label="Official website of the State of New Jersey">
            ...
            <div class="usa-banner__inner">
              <div class="grid-col-fill tablet:grid-col-auto" aria-hidden="true">
                <p class="usa-banner__header-text">
                  An official website of the State of New Jersey
                </p>
            ...
            <div class="grid-row grid-gap-lg">
              <div class="usa-banner__guidance tablet:grid-col-6">
                ...
                <div class="usa-media-block__body">
                  <p>
                    <strong>Official websites use .nj.gov</strong><br />A
                    <strong>.nj.gov</strong> website belongs to an official government organization
                    in New Jersey.
                  </p>
                </div>
              </div>
